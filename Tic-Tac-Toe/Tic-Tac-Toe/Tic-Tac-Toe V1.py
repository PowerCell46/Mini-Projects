...
while the_players_want_to_play:
    player_vs_player_or_player_vs_bot = str(
    input("How do you wish to play? Versus a bot or versus another player? (with a bot/with another player): "))
    first_row = ["□", "□", "□"]
    second_row = ["□", "□", "□"]
    third_row = ["□", "□", "□"]
    print("\n")
    ...
    while the_game_is_running:
        ...
        if index % 2 == 0:
            ...
            time.sleep(0.2)
            if player_vs_player_or_player_vs_bot == "with another player":
                ...
                time.sleep(0.2)
            elif player_vs_player_or_player_vs_bot == "with a bot":
